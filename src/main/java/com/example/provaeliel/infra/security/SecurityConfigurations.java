    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/authorization/register").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/user/self/update").authenticated()




                        // TODAS TEM QUE ESTAR PELOMENOS AUTENTICADA
